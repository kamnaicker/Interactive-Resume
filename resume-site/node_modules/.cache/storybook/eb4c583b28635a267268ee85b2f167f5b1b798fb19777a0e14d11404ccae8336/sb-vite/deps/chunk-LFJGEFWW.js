import {
  ...
  keywords,
  types$1
} from "./chunk-OF2HJ5ZN.js";
import {
  __export
} from "./chunk-GEPAX6R6.js";
import {
  VERSION
} from "./chunk-7U4N3MNA.js";
import {
  bind_this,
  check_target,
  component,
...
function handle_type_annotation(node, state) {
  switch (node.type) {
    ...
    case "TSFunctionType":
      ...
      state.commands.push("(");
      sequence2(parameters2, state, false, handle);
      state.commands.push(") => ");
...
function PreviewRender($$anchor, $$props) {
  ...
  let tmp = storyFn()(), Component4 = mutable_source(tmp.Component), props = mutable_source(fallback(tmp.props, () => ({}), true)), on = mutable_source(tmp.on), argTypes = mutable_source(tmp.argTypes);
  let firstTime = true;
...
//# sourceMappingURL=chunk-LFJGEFWW.js.map
